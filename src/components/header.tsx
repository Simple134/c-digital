...
const Header = () => {
    ...
    return (
        <Container className="!w-full bg-transparent relative z-[100]">
            <div className={`flex ${pathname === "/linktree" ? "justify-center" : "justify-between"} items-center text-white !w-full pt-4 relative z-[100]`} >
                ...
                {/* Desktop Navigation */}
               {pathname !== "/linktree" && <div className=" space-x-8 lg:block hidden relative z-50">
                    ...
                    <Link href="/servicios" className={` ${pathname === "/servicios" ? "text-[#01aaa8] font-bold" : "hover:text-[#9F9F9F] font-normal"} `}>Servicios</Link>
