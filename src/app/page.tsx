...
const PORTFOLIO = [
  { href: "/trabajos/branding", img: "/proyectos/portada-branding.jpg", category: "Branding / Identity", title: "OSY Excavator", cls: "item-1" },
  { href: "/trabajos/web", img: "/proyectos/portada-web.jpg", category: "Web Design / UX", title: "Gestiono Marketplace", cls: "item-2" },
  { href: "/trabajos/app", img: "/proyectos/portada-app.jpg", category: "Mobile App / UI", title: "Brigada de Rescate", cls: "item-3" },
  { href: "/trabajos/rebranding", img: "/proyectos/portada-rebranding.jpg", category: "Rebranding", title: "Alas de Larimar", cls: "item-4" },
  { href: "/trabajos/seo", img: "/proyectos/portada-seo.jpg", category: "SEO / Marketing Digital", title: "Posicionamiento SEO", cls: "item-5" },
];
    ...
    <div ref={containerRef}>
      ...
      <section className="hero">
        ...
        <p className="hero-tagline">
          Somos el equipo de desarrollo digital que necesita tu negocio para crecer.
        </p>
      </section>
      ...
      <section className="portfolio container">
        ...
        <div className="portfolio-grid">
          {PORTFOLIO.map(item => (
            <Link key={item.href} href={item.href} className={`portfolio-item ${item.cls} reveal-up`}>
              <Image src={item.img} alt={item.title} width={800} height={600} style={{ width: "100%", height: "auto" }} />
        ...
        <div className="why-us-inner">
          <div>
            ...
            <div className="why-items">
              {[
                { num: "01", title: "Resultados medibles, no promesas.", body: "Cada proyecto que entregamos incluye métricas claras de rendimiento. No trabajamos por intuición: definimos KPIs desde el primer día y los usamos para tomar decisiones." },
                { num: "02", title: "Equipo pequeño, atención real.", body: "No somos una agencia masiva donde tu proyecto se pierde entre cientos. Trabajamos con pocos clientes a la vez para dedicarle el tiempo y la energía que tu negocio merece." },
                { num: "03", title: "Tecnología adaptada a tu escala.", body: "No te vendemos herramientas que no necesitas. Seleccionamos la tecnología justa para tu momento actual, con capacidad de crecer contigo sin deuda técnica innecesaria." },
              ].map(w => (
        ...
        <div className="pricing-grid">
          {PLANS.map(plan => (
            <div key={plan.slug} className={`pricing-card reveal-up${plan.featured ? " pricing-card--featured" : ""}`}>
              ...
              <div>
                ...
                <div className="plan-price">
                  <span className={`plan-usd${plan.slug === "estrategico" ? " plan-custom" : ""}`}>
                    {plan.usd}{plan.period && <span className="plan-period">{plan.period}</span>}
                  </span>
              ...
              <Link href={`/contacto?plan=${plan.slug}`} className="pricing-btn">
                {plan.slug === "estrategico" ? "Solicitar diagnóstico" : "Empezar plan"}
              </Link>
            </div>
          ))}
        </div>
        ...
        <div className="logos-carousel">
          <div className="logos-track">
            {[...LOGOS, ...LOGOS].map((logo, i) => (
              <Image key={i} src={`/logos-empresas/${logo}.svg`} alt={logo} width={120} height={32} style={{ height: "32px", width: "auto" }} />
            ))}
          </div>
        </div>
      </section>
