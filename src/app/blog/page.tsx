...
const POSTS_DEFAULT = [
  {
    ...
    excerpt:
      "Antes de firmar un contrato con una agencia, necesitas hacerte estas preguntas. Aprende a evaluar propuestas, detectar red flags y elegir el socio correcto para tu negocio.",
    date: "10 mayo 2026",
