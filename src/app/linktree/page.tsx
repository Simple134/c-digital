        ...
        <div className="text-white min-h-screen font-sans relative overflow-x-hidden">
            <div className="relative max-w-[680px] mx-auto px-5 py-16 pb-24 z-10">
                ...
                <div className='flex items-center justify-center mb-12'>
                    <p className='text-gray-400 text-center'>Agencia de Marketing y Diseño especialiazda en <br /> Digitalizar Negocios</p>
                </div>
                <div className="grid grid-cols-3 gap-[15px] mb-12" style={{ animation: 'fadeInUp 0.8s ease-out 0.2s both' }}>
                    {stats.map((stat, index) => (
                        ...
                        >
                            <span className="block text-[28px] font-bold text-[#00FF7C] mb-1">{stat.value}</span>
                            <span className="block text-[13px] text-gray-400 font-medium">{stat.label}</span>
                        </div>
                    ))}
                </div>
                ...
                <div className="flex flex-col gap-[15px] mb-8" style={{ animation: 'fadeInUp 0.8s ease-out 0.3s both' }}>
                    <a
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Visita Nuestro Sitio Web</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Descubre todos nuestros servicios y portafolio completo</span>
                        </div>
                ...
                <div className="flex flex-col gap-[15px] mb-8" style={{ animation: 'fadeInUp 0.8s ease-out 0.4s both' }}>
                    <a
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Brief de Auditoría</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Solicita una auditoría digital completa para tu negocio</span>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">WhatsApp de Asistente</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Chatea con nosotros para resolver tus dudas al instante</span>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Agenda una Consultoría</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Reserva una llamada gratuita con nuestro equipo</span>
                        </div>
                ...
                <div className="grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-3 mb-8" style={{ animation: 'fadeInUp 0.8s ease-out 0.5s both' }}>
                    {/* YouTube */}
                    <a
                    ...
                    >
                        <div className="w-10 h-10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            ...
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M7 2C4.23858 2 2 4.23858 2 7V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V7C22 4.23858 19.7614 2 17 2H7Z" stroke="url(#instagramGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M16 11.37C16.1234 12.2022 15.9813 13.0522 15.5938 13.799C15.2063 14.5458 14.5931 15.1514 13.8416 15.5297C13.0901 15.9079 12.2384 16.0396 11.4078 15.9059C10.5771 15.7723 9.80976 15.3801 9.21484 14.7852C8.61991 14.1902 8.22773 13.4229 8.09406 12.5922C7.9604 11.7616 8.09206 10.91 8.47032 10.1584C8.84858 9.40685 9.45418 8.79374 10.201 8.40624C10.9478 8.01874 11.7978 7.87658 12.63 8C13.5226 8.09238 14.352 8.51473 14.9922 9.18784C15.6324 9.86095 16.0375 10.7369 16.13 11.63L16 11.37Z" stroke="url(#instagramGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M17.5 6.5H17.51" stroke="url(#instagramGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                ...
                <div className="flex flex-col gap-[15px] mb-8" style={{ animation: 'fadeInUp 0.8s ease-out 0.6s both' }}>
                    {/* Branding */}
                    <a
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Diseño de Marca</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Branding profesional y diseño de identidad corporativa</span>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Desarrollo Web</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Sitios web corporativos, tiendas online y sistemas personalizados</span>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Marketing Digital</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Gestión de redes sociales y publicidad digital</span>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <span className="block text-base font-semibold mb-1">Posicionamiento SEO</span>
                            <span className="block text-[13px] text-gray-400 leading-[1.4]">Aparece primero en Google y aumenta tu visibilidad</span>
                        </div>
                ...
                {/* Contact Section */}
                <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl p-8 mt-10" style={{ animation: 'fadeInUp 0.8s ease-out 0.7s both' }}>
                    <h3 className="text-xl font-bold text-center mb-6">Información de Contacto</h3>
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3 text-gray-400">
                            <div className="w-10 h-10 min-w-[40px] bg-gray-800 rounded-lg flex items-center justify-center text-[#00FF7C]">
                                <Mail size={20} />
                            </div>
                            <a href="mailto:hola@estudiocdigital.com" className="text-white hover:text-[#00d9ff] transition-colors">
                        ...
                        <div className="flex items-center gap-3 text-gray-400">
                            ...
                            <a href="tel:+17867557025" className="text-white hover:text-[#00d9ff] transition-colors">
                                +1 (786) 755-7025
                            </a>
                        </div>
                        <div className="flex items-center gap-3 text-gray-400">
                            ...
                            <span className="text-white">Concepción La Vega, República Dominicana</span>
                        </div>
                    </div>
                </div>

                {/* Footer */}
                <footer className="text-center mt-16 pt-8 border-t border-[#1a1a1a] text-gray-400 text-sm" style={{ animation: 'fadeIn 1s ease-out 0.8s both' }}>
                    <p>© 2025 C Digital. Todos los derechos reservados.</p>
                    <p className="mt-2 text-xs">Diseñando tus sueños para construir tu realidad.</p>
                </footer>
            </div>
